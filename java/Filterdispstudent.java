...
public class Filterdispstudent extends Filter {

    private Displaystudentfortadapter oldadapter1;
    private ArrayList<Oldstudentmodel> oldfilterlist1;

    public Filterdispstudent(Displaystudentfortadapter displaystudentfortadapter, ArrayList<Oldstudentmodel> oldfilterlist1) {
