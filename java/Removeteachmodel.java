...
public class Removeteachmodel
{

    private  String abname,absid,absection,abemail,abpassword,abphone,abaddress,abage,abgender;


    public Removeteachmodel(String abname, String absid, String absection, String abemail, String abpassword, String abphone, String abaddress, String abage, String abgender) {
        this.abname = abname;
        this.absid = absid;
