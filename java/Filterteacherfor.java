...
public class Filterteacherfor extends Filter {

    private Displatteacherfortadapter adapter;
    private ArrayList<teachermodel> filterlist;

    public Filterteacherfor(Displatteacherfortadapter adapter, ArrayList<teachermodel> filterList) {
